...
- Node.js 18+
- منفذ مفتوح (افتراضي `8788`) أو خلف Nginx مع HTTPS
...
| المتغير | الوصف |
|---------|--------|
| `PORT` | منفذ الاستماع (افتراضي 8788) |
...
- عنوان الـ API مثل: `https://plans.example.com` أو `http://IP:8788`
- نفس قيمة `API_KEY`
...
بدل `http://IP:8788` — بدون تغيير منطق التطبيق.
